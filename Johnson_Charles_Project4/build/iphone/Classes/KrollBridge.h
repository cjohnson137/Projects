...
@interface Johnson_Charles_Project4Object : KrollCoverageObject {
#else
@interface Johnson_Charles_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Johnson_Charles_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Johnson_Charles_Project4Object *_johnson_charles_project4;
    KrollObject* console;
	BOOL shutdown;
