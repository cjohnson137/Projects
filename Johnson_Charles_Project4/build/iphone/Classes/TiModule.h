...
/**
 The base class for all Johnson_Charles_Project4 modules
 */
...
/**
 Johnson_Charles_Project4 Platform calls this method on startup.
 */
-(void)startup;

/**
 Johnson_Charles_Project4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Johnson_Charles_Project4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Johnson_Charles_Project4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Johnson_Charles_Project4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
