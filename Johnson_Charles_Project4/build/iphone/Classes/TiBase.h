...
// in simulator we redefine to format for Johnson_Charles_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.johnson_charles_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.johnson_charles_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIJohnson_Charles_Project4NativeItemNone = -1, 
	UIJohnson_Charles_Project4NativeItemSpinner = -2,
	UIJohnson_Charles_Project4NativeItemProgressBar = -3,
	
	UIJohnson_Charles_Project4NativeItemSlider = -4,
	UIJohnson_Charles_Project4NativeItemSwitch = -5,
	UIJohnson_Charles_Project4NativeItemMultiButton = -6,
	UIJohnson_Charles_Project4NativeItemSegmented = -7,
	
	UIJohnson_Charles_Project4NativeItemTextView = -8,
	UIJohnson_Charles_Project4NativeItemTextField = -9,
	UIJohnson_Charles_Project4NativeItemSearchBar = -10,
	
	UIJohnson_Charles_Project4NativeItemPicker = -11,
	UIJohnson_Charles_Project4NativeItemDatePicker = -12,
	
	UIJohnson_Charles_Project4NativeItemInfoLight = -13,
	UIJohnson_Charles_Project4NativeItemInfoDark = -14,
	
	UIJohnson_Charles_Project4NativeItemDisclosure = -15,
	
	UIJohnson_Charles_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Johnson_Charles_Project4 instances of
