...
//@interface Johnson_Charles_Project4Object : NSObject
//@end

@interface Johnson_Charles_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Johnson_Charles_Project4Object class]])
		{
			for (NSString *key in [[(Johnson_Charles_Project4Object*)o modules] allKeys])
			{
