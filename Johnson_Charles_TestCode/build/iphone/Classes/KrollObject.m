...
//@interface Johnson_Charles_TestCodeObject : NSObject
//@end

@interface Johnson_Charles_TestCodeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Johnson_Charles_TestCodeObject class]])
		{
			for (NSString *key in [[(Johnson_Charles_TestCodeObject*)o modules] allKeys])
			{
