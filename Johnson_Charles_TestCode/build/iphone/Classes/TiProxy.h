...
//Rare exceptions to indicate a bug in the _johnson_charles_testcode code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Johnson_Charles_TestCode proxies.
 */
