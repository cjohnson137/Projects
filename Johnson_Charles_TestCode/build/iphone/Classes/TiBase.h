...
// in simulator we redefine to format for Johnson_Charles_TestCode Developer console
...
{\
	NSString * exceptionName = [@"org.johnson_charles_testcode." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.johnson_charles_testcode";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIJohnson_Charles_TestCodeNativeItemNone = -1, 
	UIJohnson_Charles_TestCodeNativeItemSpinner = -2,
	UIJohnson_Charles_TestCodeNativeItemProgressBar = -3,
	
	UIJohnson_Charles_TestCodeNativeItemSlider = -4,
	UIJohnson_Charles_TestCodeNativeItemSwitch = -5,
	UIJohnson_Charles_TestCodeNativeItemMultiButton = -6,
	UIJohnson_Charles_TestCodeNativeItemSegmented = -7,
	
	UIJohnson_Charles_TestCodeNativeItemTextView = -8,
	UIJohnson_Charles_TestCodeNativeItemTextField = -9,
	UIJohnson_Charles_TestCodeNativeItemSearchBar = -10,
	
	UIJohnson_Charles_TestCodeNativeItemPicker = -11,
	UIJohnson_Charles_TestCodeNativeItemDatePicker = -12,
	
	UIJohnson_Charles_TestCodeNativeItemInfoLight = -13,
	UIJohnson_Charles_TestCodeNativeItemInfoDark = -14,
	
	UIJohnson_Charles_TestCodeNativeItemDisclosure = -15,
	
	UIJohnson_Charles_TestCodeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Johnson_Charles_TestCode instances of
