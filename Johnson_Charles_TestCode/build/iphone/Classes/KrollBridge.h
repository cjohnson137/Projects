...
@interface Johnson_Charles_TestCodeObject : KrollCoverageObject {
#else
@interface Johnson_Charles_TestCodeObject : KrollObject {
#endif
@private
...
extern NSString * Johnson_Charles_TestCode$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Johnson_Charles_TestCodeObject *_johnson_charles_testcode;
    KrollObject* console;
	BOOL shutdown;
