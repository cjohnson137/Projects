...
/**
 Base class for all Johnson_Charles_TestCode views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Johnson_Charles_TestCode view hierarchy (such as wrapped iOS UIViews) was touched.
