...
// in simulator we redefine to format for Johnson_Charles_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.johnson_charles_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.johnson_charles_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIJohnson_Charles_Project3NativeItemNone = -1, 
	UIJohnson_Charles_Project3NativeItemSpinner = -2,
	UIJohnson_Charles_Project3NativeItemProgressBar = -3,
	
	UIJohnson_Charles_Project3NativeItemSlider = -4,
	UIJohnson_Charles_Project3NativeItemSwitch = -5,
	UIJohnson_Charles_Project3NativeItemMultiButton = -6,
	UIJohnson_Charles_Project3NativeItemSegmented = -7,
	
	UIJohnson_Charles_Project3NativeItemTextView = -8,
	UIJohnson_Charles_Project3NativeItemTextField = -9,
	UIJohnson_Charles_Project3NativeItemSearchBar = -10,
	
	UIJohnson_Charles_Project3NativeItemPicker = -11,
	UIJohnson_Charles_Project3NativeItemDatePicker = -12,
	
	UIJohnson_Charles_Project3NativeItemInfoLight = -13,
	UIJohnson_Charles_Project3NativeItemInfoDark = -14,
	
	UIJohnson_Charles_Project3NativeItemDisclosure = -15,
	
	UIJohnson_Charles_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Johnson_Charles_Project3 instances of
