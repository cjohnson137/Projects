 ...
 * to send analytic data that can be viewed on the Johnson_Charles_Project3 Dashboard.
 *
 * For information on getting started with Johnson_Charles_Project3 Platform Services,
