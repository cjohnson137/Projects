...
//@interface Johnson_Charles_Project3Object : NSObject
//@end

@interface Johnson_Charles_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Johnson_Charles_Project3Object class]])
		{
			for (NSString *key in [[(Johnson_Charles_Project3Object*)o modules] allKeys])
			{
