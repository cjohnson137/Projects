...
@interface Johnson_Charles_Project3Object : KrollCoverageObject {
#else
@interface Johnson_Charles_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Johnson_Charles_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Johnson_Charles_Project3Object *_johnson_charles_project3;
    KrollObject* console;
	BOOL shutdown;
