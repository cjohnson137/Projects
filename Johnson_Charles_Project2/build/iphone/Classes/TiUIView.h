...
/**
 Base class for all Johnson_Charles_Project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Johnson_Charles_Project2 view hierarchy (such as wrapped iOS UIViews) was touched.
