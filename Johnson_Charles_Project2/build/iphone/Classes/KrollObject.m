...
//@interface Johnson_Charles_Project2Object : NSObject
//@end

@interface Johnson_Charles_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Johnson_Charles_Project2Object class]])
		{
			for (NSString *key in [[(Johnson_Charles_Project2Object*)o modules] allKeys])
			{
