...
@interface Johnson_Charles_Project2Object : KrollCoverageObject {
#else
@interface Johnson_Charles_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Johnson_Charles_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Johnson_Charles_Project2Object *_johnson_charles_project2;
    KrollObject* console;
	BOOL shutdown;
