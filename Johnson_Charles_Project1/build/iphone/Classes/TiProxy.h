...
//Rare exceptions to indicate a bug in the _johnson_charles_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Johnson_Charles_Project1 proxies.
 */
