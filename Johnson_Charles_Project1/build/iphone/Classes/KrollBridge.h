...
@interface Johnson_Charles_Project1Object : KrollCoverageObject {
#else
@interface Johnson_Charles_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Johnson_Charles_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Johnson_Charles_Project1Object *_johnson_charles_project1;
    KrollObject* console;
	BOOL shutdown;
