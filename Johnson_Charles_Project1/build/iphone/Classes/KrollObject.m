...
//@interface Johnson_Charles_Project1Object : NSObject
//@end

@interface Johnson_Charles_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Johnson_Charles_Project1Object class]])
		{
			for (NSString *key in [[(Johnson_Charles_Project1Object*)o modules] allKeys])
			{
